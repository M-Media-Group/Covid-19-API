...
for row in recent_rows:
	...
	if (row['Country_Region'] not in recent_data):
		...
		if(row['Country_Region'] in country_array):
			recent_data[row['Country_Region']]['All']['population'] = int(country_array[row['Country_Region']])
...
global_array = {'All': {'population': global_population, 'deaths': 0, 'recovered': 0,'confirmed': 0}}
