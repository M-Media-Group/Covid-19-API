...
def lambda_handler(event, context):
	...
	url ='https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_'+event['queryStringParameters']['status'].lower()+'_global.csv'
	...
	for row in rows:
		...
		# 	continue
	global_array = {'All': {'population': global_population, 'deaths': 0, 'confirmed': 0, 'dates': {}}}
